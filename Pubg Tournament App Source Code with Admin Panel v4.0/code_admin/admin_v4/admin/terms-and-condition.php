...
$selquery4 = "select * from tbl_terms_conditions where id=1";
...
if(isset($_POST['btnUpdate']))
  {
    ...
    $txtDate = date("Y-m-d H:i:s");
      ...
      $updquery = "update tbl_terms_conditions set content='$txtDesc', modify_by=$userid, date_modify='$txtDate' where id=1";
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card-box">
                  ...
                  <h4 class="m-t-0 header-title"><b>Terms And Condition</b></h4>
                  <p class="text-muted font-13 m-b-30">
                      Define your Terms And Condition here in detail.
                  </p>
                  <form action="terms-and-condition.php" data-parsley-validate novalidate method="post">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group text-right m-b-0">
                          ...
                          <a href="terms-and-condition" class="btn btn-default waves-effect waves-light"> Cancel</a>
                        </div>
                      </div>
                    </div>
                  </form>
