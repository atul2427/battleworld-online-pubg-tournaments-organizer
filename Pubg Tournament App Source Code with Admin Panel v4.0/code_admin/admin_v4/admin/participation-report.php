...
if(isset($_GET['rid']))
{
  ...
  $getquery1 = "select p.match_id, m.title, p.id as partiId, p.user_id, u.fname, u.lname, u.username, u.email, u.mobile from participant_details as p
  left join user_details as u on u.id=p.user_id
  left join match_details as m on m.id=p.match_id
  where p.user_id='{$rid}' group by p.match_id";
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card-box">
                  ...
                  <p class="text-muted font-13 m-b-30">
                      Match played by particular user.
                  </p>
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap table-loader" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Mobile</th>
                            <th class="text-center">Detail Report</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php while ($selres = mysqli_fetch_array($getresult1)){ ?>
                          <tr class="font-13">
                              ...
                              <td class="text-center"><a href="participation-detail-report.php?uid=<?php echo $selres['user_id'];?>&mid=<?php echo $selres['match_id'];?>" class="remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail Report">Report <i class="fa fa-arrow-circle-right"></i></a></td>
                          </tr>
                        <?php } ?>
                      </tbody>
                  </table>
