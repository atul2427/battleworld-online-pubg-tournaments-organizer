...
if (isset($body->item->name)) {
    ...
    if($id == 23898180) {
$selquery = "select * from tbl_payouts order by id desc";
...
if(isset($_POST['btnSave']))
{
  ...
  $insquery = "insert into tbl_payouts (name, subtitle, message, amount, coins, image, status, mode, currency) values('{$txtPayMethod}', '{$txtSubTittle}', '{$txtPlaceHolder}', '{$txtAmount}', '{$txtCoin}', '{$txtImg}', '0', '{$txtPayMode}', '{$txtCurrency}')";
...
if(isset($_GET['id']))
{
  ...
  $getquery1 = "select * from tbl_payouts where id={$id}";
...
if(isset($_POST['btnUpdate']))
{
  ...
  if (!empty($_FILES['txtImg']['name'])) {
    $insquery = "update tbl_payouts set name='{$txtPayMethod}', subtitle='{$txtSubTittle}', message='{$txtPlaceHolder}', amount='{$txtAmount}', coins='{$txtCoin}', image='{$txtImg}', mode='{$txtPayMode}', currency='{$txtCurrency}' where id=$id";
  }
  else
  {
    $insquery = "update tbl_payouts set name='{$txtPayMethod}', subtitle='{$txtSubTittle}', message='{$txtPlaceHolder}', amount='{$txtAmount}', coins='{$txtCoin}', mode='{$txtPayMode}', currency='{$txtCurrency}' where id=$id";
  }
...
if(isset($_GET['did']))
{
  ...
  $delquery = "delete from tbl_payouts where id=$did";
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select name="txtPayMethod" parsley-trigger="change" required class="form-control" id="txtPayMethod">
                                    ...
                                    <option <?php if($getres1['name'] == 'PayTm') { echo 'selected'; } ?> value="PayTm">PayTm</option>
                                    <option <?php if($getres1['name'] == 'PayPal') { echo 'selected'; } ?> value="PayPal">PayPal</option>
                                    <option <?php if($getres1['name'] == 'UPI') { echo 'selected'; } ?> value="UPI">UPI</option>
                                    <option <?php if($getres1['name'] == 'GooglePay') { echo 'selected'; } ?> value="GooglePay">GooglePay</option>
                                    <option <?php if($getres1['name'] == 'PhonePe') { echo 'selected'; } ?> value="PhonePe">PhonePe</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-12">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select name="txtPayMode" required class="form-control" parsley-trigger="change" id="txtPayMode">
                                    <option value="">-- Select --</option>
                                    <option value="0" <?php if($getres1['mode']=='0') { echo 'selected'; } ?>>Debit</option>
                                    <option value="1" <?php if($getres1['mode']=='1') { echo 'selected'; } ?>>Credit</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-12">
