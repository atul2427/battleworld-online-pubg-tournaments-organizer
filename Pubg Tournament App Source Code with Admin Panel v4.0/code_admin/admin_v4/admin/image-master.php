...
if(isset($_POST['btnSave']))
{
  ...
  {
      $insquery = "insert into tbl_image (image_name,image,date_created) values('{$txtImgName}','{$txtImg}','{$txtDate}')";
  }
...
if(isset($_POST['btnUpdate']))
{
  ...
  if (!empty($_FILES['txtImg']['name'])) {
    $insquery = "update tbl_image set image_name='{$txtImgName}',image='{$txtImg}',date_created='{$txtMdate}' where img_id = $id";
  }
  else
  {
    $insquery = "update tbl_image set image_name='{$txtImgName}',date_created='{$txtMdate}' where img_id = $id"; 
  }
