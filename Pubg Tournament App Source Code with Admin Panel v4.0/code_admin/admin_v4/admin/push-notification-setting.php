...
if(isset($_POST['btnUpdate']))
  {
    ...
    $txtAppId = mysqli_real_escape_string($conn,$_POST['txtAppId']);
    $txtAuthKey = mysqli_real_escape_string($conn,$_POST['txtAuthKey']);
    $txtDate = date("Y-m-d H:i:s");
      
      $updquery = "update tbl_push_notification set appid='$txtAppId', auth_key='$txtAuthKey', modify_by=$userid, date_modify='$txtDate' where id=1";
      
      if(mysqli_query($conn,$updquery))
      {
          header("Location:push-notification-setting");
      }
      else
      {
          //echo $updquery;
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card-box">
                  ...
                  <h4 class="m-t-0 header-title"><b>Push Notification</b></h4>
                  <p class="text-muted font-13 m-b-30">
                      Change Push Notification keys from here.
                  </p>
                  <form action="push-notification-setting.php" data-parsley-validate novalidate method="post">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="txtAppId" parsley-trigger="change" required class="form-control" id="txtAppId" value="<?php echo $selres4['appid']; ?>">
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label for="txtAuthKey">Authorization Key *</label>
                                  <input type="text" name="txtAuthKey" parsley-trigger="change" required class="form-control" id="txtAuthKey" value="<?php echo $selres4['auth_key']; ?>">
                                </div>
                              </div>
                            </div><br>
                        </div>
