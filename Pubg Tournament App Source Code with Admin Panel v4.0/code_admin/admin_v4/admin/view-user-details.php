                ...
                <div class="row row-eq-height">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card-box">
                          ...
                          <p class="text-muted font-13 m-b-30">
                              ...
                              <p class="text-muted"><strong>PUBG User Name :</strong> <span class="m-l-15"><?php echo $getres1['pubg_username']; ?></span></p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card-box">
                          ...
                          <p class="text-muted font-13 m-b-30">
                              ...
                              <!-- <p class="text-muted"><strong>WhatsApp Number :</strong> <span class="m-l-15"><?php //echo $getres1['whatsapp_num']; ?></span></p> -->
                          </p>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card-box">
                          ...
                          <hr>
                          <p class="text-muted font-13 m-b-30">
                              <p class="text-muted"><strong>Promo Code :</strong> <span class="m-l-15"><?php echo $getres1['promocode']; ?></span></p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div class="card-box">
                          <h4 class="text-uppercase font-600">Registration Date</h4>
                          <hr>
                          <p class="text-muted font-13 m-b-30">
