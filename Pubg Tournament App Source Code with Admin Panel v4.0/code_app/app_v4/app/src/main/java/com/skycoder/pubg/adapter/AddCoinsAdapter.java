    ...
    public void onBindViewHolder(final AddCoinsAdapter.ViewHolder holder, int position) {
        ...
        holder.SingleItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MyWalletActivity)context).Add(payoutPojo.getName(), payoutPojo.getSubtitle(), payoutPojo.getMessage(), payoutPojo.getAmount(), payoutPojo.getCoins(), payoutPojo.getId(), payoutPojo.getStatus(), payoutPojo.getImage(),payoutPojo.getMode(),payoutPojo.getCurrency());
            }
        });
